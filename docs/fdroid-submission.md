...
| Monotonic `versionCode` | plain counter in `pubspec.yaml`; `0.3.0` is release `15` |
...
| ABI | `VercodeOperation` | versionCode at `0.3.0+15` |
| --- | --- | --- |
| `armeabi-v7a` | `%c * 10 + 1` | 151 |
| `arm64-v8a` | `%c * 10 + 2` | 152 |
| `x86_64` | `%c * 10 + 3` | 153 |
...
`CurrentVersionCode` must be the *highest* of the three (153), not the build
